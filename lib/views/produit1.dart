...
class produit1 extends StatefulWidget {
  const produit1({super.key});


  @override
  State<produit1> createState() => _produit1State();
}

class _produit1State extends State<produit1> {
  int _counter = 0;
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(image: AssetImage("assets/image/food1.png"),
                    fit: BoxFit.contain
                  )
                ),
              ),
            ...
            SizedBox(height: 20,),
            Text("Cheeseburger Wendy's Burger", style: TextStyle(
              fontSize: 25,
              ...
              Row(children: [
                ...
                SizedBox(width: 3,),
                Text("4.9", style: TextStyle(fontSize: 20, color: Colors.grey),),
                SizedBox(width: 3,),
                Text("-", style: TextStyle(fontSize: 30, color: Colors.grey),),
                SizedBox(width: 3,),
                Text("26 mins", style: TextStyle(fontSize: 20, color: Colors.grey),),
              ],),
              SizedBox(height: 15,),
