...
class produit2 extends StatefulWidget {
  const produit2({super.key});


  @override
  State<produit2> createState() => _produit2State();
}

class _produit2State extends State<produit2> {
  int _counter = 0;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(image: AssetImage("assets/image/food2.png"),
                          fit: BoxFit.contain
                      )
                  ),
                ),
              ...
              SizedBox(height: 20,),
              Text("Hamburger Veggie Burger", style: TextStyle(
                  fontSize: 25,
              ...
              Row(children: [
                ...
                SizedBox(width: 3,),
                Text("4.8", style: TextStyle(fontSize: 20, color: Colors.grey),),
                SizedBox(width: 3,),
              ...
              SizedBox(height: 15,),
              Text("Enjoy our delicious Hamburger Veggie Burger, made \nwith a savory blend of fresh vegetables and herbs, \ntopped with crisp lettuce, juicy tomatoes, and tangy \npickles, all served on a soft, toasted bun. ",
                style: TextStyle(
                    fontSize: 17,
                    height: 1.7,
                    color: Colors.grey
