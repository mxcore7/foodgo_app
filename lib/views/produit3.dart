...
class produit3 extends StatefulWidget {
  const produit3({super.key});


  @override
  State<produit3> createState() => _produit3State();
}

class _produit3State extends State<produit3> {
  int _counter = 0;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(image: AssetImage("assets/image/food3.png"),
                          fit: BoxFit.contain
                      )
                  ),
                ),
              ...
              SizedBox(height: 20,),
              Text("Hamburger Chicken Burger", style: TextStyle(
                  fontSize: 25,
              ...
              Row(children: [
                ...
                SizedBox(width: 3,),
                Text("42 mins", style: TextStyle(fontSize: 20, color: Colors.grey),),
              ],),
              SizedBox(height: 15,),
              Text("Our chicken burger is a delicious and healthier \nalternative to traditional beef burgers, perfect for those \nlooking for a lighter meal option. Try it today and \nexperience the mouth-watering flavors of our \nHamburger Chicken Burger!",
                style: TextStyle(
                    fontSize: 17,
                    height: 1.7,
                    color: Colors.grey
